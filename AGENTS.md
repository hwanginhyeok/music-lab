...
Use browsing and development skills only when the user selects them or they add concrete value.
Routine bounded work does not require a startup skill or a fixed brainstorming/planning/TDD chain.
Follow the inherited language policy for persisted work.
