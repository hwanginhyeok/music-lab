...
> Suite의 정점. Track 5의 정적이 깨지면서 풀밴드가 한꺼번에 들어온다. "이게 설렘이 아니었어. 네가 보고 싶었던 거야." 핑계가 무너지는 순간.
...
- **Track 5의 마지막 침묵 직후, 드럼 필인 하나로 시작.** 그 대비가 전부다.
- Suite에서 가사가 가장 밀도 높은 트랙. 재즈지만 여기서는 팝처럼 꽉 채운다. 쏟아내야 하니까.
