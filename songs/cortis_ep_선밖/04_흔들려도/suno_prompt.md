# 흔들려도 (Even When I Shake) — Suno 프롬프트 v1

## Style of Music (Suno 스타일 박스 입력)
```
Korean boy group melodic pop R&B, soft mellow beat, warm Rhodes electric piano and jazz sequence layer, intimate vulnerable mood, restrained percussion, sparse warm instrumentation, Korean-English code-switching with English hook call, the emotional turn of the EP, slightly more polished, 2-3 min
```

## Exclude / Negative
```
hard trap, aggressive 808, shouting, EDM, distorted synth, female vocal, upbeat party
```
