...
| # | 태스크 | 시작일 | blocked | 비고 |
|---|--------|--------|---------|------|
| 5-14 | '왜 그리 울고만 있어요? 그리움만 쌓이게' 재즈 트리오 EP 9곡 | 2026-04-30 | — | Bill Evans 톤(modal jazz), 피아노+더블베이스+브러시드럼. 04 색소폰(Stan Getz), 06 한국어 여성 보컬(Norah Jones × 나윤선). songs/14_geuriumi/ |
...
| 6-1 | YouTube 관리 파이프라인 구축 | 2026-04-09 | 5-14 EP 완료 후 평가 | /youtube_list(목록), /youtube_delete(삭제), 통계 기능 구현. 채널 콘텐츠 누적 후 관리 도구 필요성 재평가. 26일 정체 (2026-05-04 기준) |
