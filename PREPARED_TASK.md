...
| 5-18 | '술병이 났다' 풀앨범 9곡 (3·3·3 동음 역설) | P1 | — | 같은 문장 "술병이 났다" 세 챕터 다른 의미. Part I 빈병/II 몸병/III 회복. **장르 확정: Late-night smoky jazz, 색소폰 중심 단일 톤** (Coleman Hawkins/Ben Webster/Stan Getz/Dexter Gordon). 333은 편성·색스 톤·BPM·키 변수로만 표현. 5-14 피아노 트리오와 차별화. 9번에만 한국어 여성 보컬 2분 피처링. 화자: 넥타이 머리 한국 아저씨. 컨셉 v0.2 완성 (`docs/albums/술병이났다.md`) — 9트랙 BPM/키/편성/색스 톤 1차안 |
